          ...
          <div class="col-sm-6">
              <div class="container">
                  <div class="card mx-5 me-0">
                      <div class="card-body">
                          <div>
                              <span class="fw-bolder">번역할 언어</span> <select id="source" class="btn btn-outline-secondary" style="margin-left:20px;">
                                  <option value="ko">한국어</option>
                                  <option value="en">영어</option>
                                  <option value="ja">일본어</option>
                                  <option value="es">스페인어</option>
                              ...
                              <button class="btn btn-outline-secondary" style="float:right">
                                  <img src="change.png" width="20" height="20" />
                              </button>
                          </div>
                          <div class="mt-2">
                              <div class="form-floating">
              ...
              <div class="container">
                  <div class="card mx-0 me-5">
                      <div class="card-body" style="height: 322px;">
                          <div>
                              <span class="fw-bolder">번역된 언어</span> <select id="target" class="btn btn-outline-secondary" style="margin-left:20px;">
                                  <option value="ko">한국어</option>
                                  <option value="en" selected="selected">영어</option>
                                  <option value="ja">일본어</option>
                                  <option value="es">스페인어</option>
              ...
              <div class="container">
                  <div class="card mx-5 me-0">
                      <div class="card-body">
                          ...
                          <div align="right">
                          <select class="btn mt-2 btn-outline-secondary">
                              <option value="0">--- 게시판 선택 ---</option>
                          </select>
                              <button class="btn mt-2">
                                  <img src="plus.png" width="17" height="20" />
                              </button>
                              <button type="button"
                                      class="btn btn-info btn-lg mt-2 text-light fw-bolder ">
                                  단어저장
