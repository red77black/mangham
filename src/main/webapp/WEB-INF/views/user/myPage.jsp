...
=======
    ...
    <!-- <link rel="stylesheet" href="/resources/css/myPageStyle.css"> -->
>>>>>>> 8662fca9faa3153da0144d3e28508a4e5e547c90
        ...
        <div class="content">
            ...
            <div class="content1">
                <div class="mypage-main">
                    <h3 class="header">My page</h3><br />

                    <table>
                        <tr>
                            <td width="120" height="45"; class="line">
            ...
            <div class="content2">
                <div class="mypage-sub">
                    <h3 class="header">SuSoo</h3><br />

                    <table class="change">
                        <tr>
                            <td width="170" height="45">
                                <span class="red-s"> -</span> <a class="a-tag" onclick="location.href='change-user.html'"> 회원정보 변경</a>
                            </td>
                            <td width="170" height="45">
                                <span class="red-s"> -</span> <a class="a-tag" onclick="location.href='change-password.html'"> 비밀번호 변경</a>
                            </td>
                        </tr>
                    </table>
                    <br />
                    ...
                    <table class="word">
                        <tr>
                            <td width="130" height="100" class="text">
                                <strong>모든 단어</strong><br />
                                <input type="button" class="all-button">
                            </td>
                            <td width="130" class="text">
                                <strong>미암기</strong><br />
                                <input type="button" class="mi-button">
                            </td>
                            <td width="130" class="text">
                                <strong>암기</strong><br />
                                <input type="button" class="am-button">
                            </td>
                        </tr>
                    </table>
                </div>
			...
			<table>
				<tr>
					<td width="120" height="45" class="line"><span class="red">
							-</span> ID</td>
					<td class="line"><span> ${sessionScope.loginVO.s_id} </span></td>
				</tr>

				<tr>
					<td width="120" height="45" class="line"><span class="red">
							-</span> 이름</td>
					<td class="line"><span> ${sessionScope.loginVO.s_name} </span></td>
				</tr>

				<tr>
					<td width="120" height="45" class="line"><span class="red">
							-</span> Email</td>
					<td class="line"><span> ${sessionScope.loginVO.s_email} </span></td>
				</tr>

				<tr>
					<td width="120" height="45" class="line"><span class="red">
							-</span> Phone</td>
					<td class="line"><span> ${sessionScope.loginVO.s_phone} </span></td>
				</tr>
			...
			<table class="change">
				<tr>
					<td width="170" height="45"><span class="red-s"> -</span> <a
						class="a-tag" href="/user/change-userForm"> 회원정보 변경</a></td>
					<td width="170" height="45"><span class="red-s"> -</span> <a
						class="a-tag" href="/user/change-passwordForm"> 비밀번호 변경</a></td>
				</tr>
			</table>
			<br />
			<table class="word">
